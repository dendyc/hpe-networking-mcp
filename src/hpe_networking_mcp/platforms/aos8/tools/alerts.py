...
async def aos8_get_alarms(ctx: Any, config_path: str = "/md") -> dict[str, Any] | str:
...
async def aos8_get_audit_trail(ctx: Any) -> dict[str, Any] | str:
...
async def aos8_get_events(ctx: Any, config_path: str = "/md") -> dict[str, Any] | str:
