...
async def aos8_ping(ctx: Any, dest: str) -> dict[str, Any] | str:
...
async def aos8_traceroute(ctx: Any, dest: str) -> dict[str, Any] | str:
...
async def aos8_show_command(ctx: Any, command: str) -> dict[str, Any] | str:
...
async def aos8_get_logs(ctx: Any, count: int = 100) -> dict[str, Any] | str:
...
async def aos8_get_controller_stats(ctx: Any) -> dict[str, Any] | str:
...
async def aos8_get_arm_history(ctx: Any, config_path: str = "/md") -> dict[str, Any] | str:
...
async def aos8_get_rf_monitor(ctx: Any, config_path: str = "/md") -> dict[str, Any] | str:
